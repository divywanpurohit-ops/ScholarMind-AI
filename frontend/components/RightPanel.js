...
export default function RightPanel() {
  ...
  return (
    <aside className="w-[340px] min-w-[340px] max-w-[340px] border-l border-slate-100 bg-white overflow-y-auto custom-scrollbar p-6 space-y-8 animate-fade-in flex-shrink-0">
